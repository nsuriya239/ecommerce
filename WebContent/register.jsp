		...
		<div class="container">
			<div class="reg">
				...
				<p>If you have previously registered with us, <a href="Login.jsp">click here</a></p>
				 <form name="form" method="POST" action="SignupServ">
					<ul>
					...
					<ul>
						...
						<li><input type="text" value="" name="mbl" required="required" onchange="phonenumber(document.form.mbl)"></li>
					</ul>			
					...
					function phonenumber(inputtxt)
					{
					  ...
					  if((inputtxt.value.match(phoneno)))
					      ...
					      return true;
					        ...
					        {
					        alert("Please enter a valid ph no");
					        return false;
					        }
					}
					</script>			
