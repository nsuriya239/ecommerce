...
<%
  //System.out.println(session +" "+session.getValue("name"));
	...
	else
	{
		...
		ArrayList<products> ap=checkoutDAOj.selectcart(uname);
        ...
        %>
                    ...
                    <div class="col-md-3 cart-total">
                        ...
                        <a class="order" href="Home.jsp">Continue Shopping</a>
                            <h3>Price Details</h3>
                            <span>Total</span>
                            <span class="total1">&#8377;<%=totalamt %></span>
                            <span>Discount</span>
                            <span class="total1">10%(Festival Offer)</span>
                            <span>Delivery Charges</span>
                            <span class="total1">&#8377;<%=totalamt*(0.1) %></span>
                            <div class="clearfix"></div>				 
                        </div>
                        ...
                        {
                        %>
                        <a class="order" href="deldetconfim.jsp">Place Order</a>
                        <%
                        }
                        %>
                    </div>
